...
Демо: [api-green-test-max.vercel.app/](https://api-green-test-max.vercel.app/)
...
Юнит-тесты на Vitest — на `chatsReducer` и `computeApiUrl`, конкретно на те места, где раньше ловил баги руками (дубли сообщений и кража фокуса поллингом).
